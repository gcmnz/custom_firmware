...
void Plane::control_failsafe()
{
    ...
    bool ignore_rc_fs = g.fs_action_long == FS_ACTION_LONG_CONTINUE && (control_mode == &mode_auto || control_mode == &mode_guided || control_mode == &mode_loiter);

    if (!ignore_rc_fs && rc_failsafe_active()) {
