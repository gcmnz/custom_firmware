...
public:
    ...
    static const struct AP_Param::GroupInfo var_info_extra[];
...
private:
    ...
    const struct AP_Param::GroupInfo *atc_var_info;
    ...
    // maximum vtol landable altitude
    AP_Int16 land_max_alt_m;
