...
bool AP_Arming_Plane::pre_arm_checks(bool display_failure)
{
    ...
    if (plane.control_mode == &plane.mode_auto && plane.mission.get_in_landing_sequence_flag() &&
...
bool AP_Arming_Plane::ins_checks(bool display_failure)
{
    ...
    if ((checks_to_perform & ARMING_CHECK_ALL) ||
        ...
        if (!plane.ekf_has_absolute_position()) {
            check_failed(ARMING_CHECK_INS, display_failure, "AHRS: position not ready");
            return false;
        }
    }
